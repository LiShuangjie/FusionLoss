...
parser.add_argument('--dataset', type=str,
                    default='cora',
                    choices=['cora', 'citeseer', 'pubmed', 'amazoncom', 'amazonpho', 'amazon-ratings', 'roman-empire','dblp', 'blogcatalog', 'flickr', 'chameleon', 'wisconsin', 'texas','film', 'cornell', 'squirrel','arxiv','arxiv-year'],
                    help='Select dataset')
parser.add_argument('--method', type=str,
                    default='gcn',
                    choices=['gcn', 'gin', 'smodel', 'jocor', 'coteaching', 'apl', 'sce', 'forward', 'backward', 'lcat', 'tss',
                             'nrgnn', 'rtgnn', 'cp', 'unionnet','r2lp', 'cgnn', 'crgnn', 'clnode', 'rncgln', 'pignn', 'dgnn','het', 'adaptloss'],
                    help="Select methods")
