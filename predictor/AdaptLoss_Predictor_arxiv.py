...
from predictor.module.adaptLoss_arxiv import  Edge_Discriminator, LabelDivision, PredictModel
    ...
    def train(self,binary_y, noise_rate):
        ...
        for epoch in range(self.conf.training['n_epochs']):
            ...
            if epoch < self.conf.model['warm_up']:
                ...
                label_loss  = self.criterion.division(self.train_mask, log_lp, log_hp,self.noisy_label, self.localsim, epoch,binary_y, noise_rate=self.noise_rate)
